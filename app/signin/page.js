...
export default function SignIn() {
  ...
  useEffect(() => {
    ...
    // Immediately redirect to dashboard, bypassing all auth
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-sm w-full space-y-6 text-center px-4 md:px-0">
        <div>
          <h2 className="text-3xl font-extrabold">Sign in to Cool Captions</h2>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-base-content/60">
            ...
            <Link
              href="https://Cool Captions.xyz/tos"
            ...
            and{" "}
            <Link
              href="https://Cool Captions.xyz/privacy-policy"
              className="link link-primary"
            >
              Privacy Policy
            </Link>
